...
- [ ] RU02 · `WidgetAssembler` · test: `WidgetAssemblerTest` · covers: assembling and normalizing parts
    - `assemble()`:
...
- [ ] RI02 · `WidgetController` · test: `WidgetControllerTest` · covers: `<WidgetForm>` · mocks: the create port, as the setup stubs it · scenarios: AC02, AC03
    - Happy Path:
...
- [ ] RS01 · `CreateWidgetTest` · scenarios: AC01, AC03
    - Happy Path:
