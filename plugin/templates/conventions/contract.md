...
- **`small-change`**: the skill that changes one thing in work that is already archived.
...
|----------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| The command that compiles the module, and where commands run from                                                          | every step, every module agent, `small-change`                                              | the run stops at its first suite run; a command is never guessed                               |
| The command that runs one test class                                                                                       | every red and green step, `small-change`                                                    | the run stops at its first suite run; a command is never guessed                               |
| The command that runs the full suite                                                                                       | every pipeline, every module agent, the close of a run, `small-change`                      | the run stops at its first suite run; a command is never guessed                               |
...
| Fact                                                                    | Who reads it                                             | Absent                                                  |
|-------------------------------------------------------------------------|----------------------------------------------------------|---------------------------------------------------------|
| The layers, the packages they map to, which may depend on which         | `plan-task`, both plan reviewers, green steps, refactor pass | classes are grouped as the code is; no rule is enforced |
...
| **Performance**: the tool, where the figure is measured, the command that runs it and keeps it out of the full suite, where a test lives             | `plan-task`, `review-plan-facts`, the performance step, every close that reruns a test | not measured: a measurable scenario gets no step, and the plan says so                                                                       |
...
| How test methods and test classes are named                                                                                                          | every red step, refactor pass, `small-change`                                    | the pattern the neighbouring tests follow                                                                                                    |
| Test base classes and shared builders, and what each provides                                                                                        | every red step, refactor pass, `small-change`                                    | the ones the neighbouring tests use                                                                                                          |
