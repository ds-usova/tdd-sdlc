...
Apply this boundary to every sentence, table cell and diagram label in `design.md`.
...
Move a repository fact that supports a decision to `design-log.md`. Do not add a reading list to the design.
